...
var image="/assets/images/balloon.png";  //Image path should be given here
var no = 20; // No of images should fall
var time = 69; // Configure whether image should disappear after x seconds (0=never):
var speed = 69; // Fix how fast the image should fall
var i, dwidth = window.width, dheight = window.height; 
var nht = dheight;
var toppos = 0;
...
for (i = 0; i < no; ++ i) {  
	...
	document.write("<div id=\"dot"+ i +"\" style=\"POSITION: absolute; Z-INDEX: "+ i +"; VISIBILITY: visible; TOP: 15px;LEFT: 15px;\"><img src='"+image+"' border=\"0\" height=32 width=32><\/div>");
}
